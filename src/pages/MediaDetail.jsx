...
const MediaDetail = () => {
   ...
   const onRemoveFavorite = async () => {
    ...
    return (
        media ? (
            <>
            <ImageHeader imgPath={tmdbConfigs.backdropPath(media.backdropPath_path || 
                media.poster_path)} />
                <Box sx={{
                   ...
                   ...uiConfigs.style.mainContent
                    ...
                    {/* media content  */}
                    <Box sx={{
                        marginTop: { sx: "-10rem", md: "-15rem" , lg: "-20rem" }
                    }}>
                        <Box sx={{
                           display: "flex",
                           flexDirection:  { md: "row", xs: "column" }
                            ...
                            {/* poster  */}
                            <Box sx={{
                                width: {sx: "70%", sm: "50%", md: "40%"},
                                margin: { xs: "0 auto 2rem", md: "0 2rem 0 0"}
                            }}>
                                <Box sx={{
                                    paddingTop: "140%",
                                    ...uiConfigs.style.backgroundImage(tmdbConfigs.posterPath(media.
                                        poster_path || media.backdropPath_path ))
                              ...
                              {media.images.backdrops.length > 0  && (
                               ...
                               {media.images.posters.length > 0 && (
                                ...
                                {/* media posters  */}
                                 ...
                                 {/* media reviews  */}
                                 <MediaReview reviews={media.reviews} media={media} mediaType=
                                 {mediaType}/>
